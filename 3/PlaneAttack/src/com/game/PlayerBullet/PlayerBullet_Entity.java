            ...
            for(int j=0;j<Main.bullets_list.size();j++){
                if(Main.enemy_list.get(i).num==1){
                    ...
                    if(Main.player_entity.level ==1){
                        if(Main.enemy_list.get(i).label.getX()-Main.bullets_list.get(j).getX()<=27&&
                                Main.bullets_list.get(j).getY()-Main.enemy_list.get(i).label.getY()<=44&&
                                Main.enemy_list.get(i).label.getY()-Main.bullets_list.get(j).getY()<=22&&
                                Main.bullets_list.get(j).getX()-Main.enemy_list.get(i).label.getX()<=71
                        ...
                        if(Main.enemy_list.get(i).label.getX()-Main.bullets_list.get(j).getX()<=44&&
                                Main.bullets_list.get(j).getY()-Main.enemy_list.get(i).label.getY()<=44&&
                                Main.enemy_list.get(i).label.getY()-Main.bullets_list.get(j).getY()<=21&&
                                Main.bullets_list.get(j).getX()-Main.enemy_list.get(i).label.getX()<=71
                    ...
                    if(Main.player_entity.level==1){
                        if(Main.enemy_list.get(i).label.getX()-Main.bullets_list.get(j).getX()<=27&&
                                Main.bullets_list.get(j).getY()-Main.enemy_list.get(i).label.getY()<=92&&
                                Main.enemy_list.get(i).label.getY()-Main.bullets_list.get(j).getY()<=22&&
                                Main.bullets_list.get(j).getX()-Main.enemy_list.get(i).label.getX()<=118
                    ...
                    if(Main.player_entity.level==1){
                        if(Main.enemy_list.get(i).label.getX()-Main.bullets_list.get(j).getX()<=27&&
                                Main.bullets_list.get(j).getY()-Main.enemy_list.get(i).label.getY()<=116&&
                                Main.enemy_list.get(i).label.getY()-Main.bullets_list.get(j).getY()<=22&&
                                Main.bullets_list.get(j).getX()-Main.enemy_list.get(i).label.getX()<=186
