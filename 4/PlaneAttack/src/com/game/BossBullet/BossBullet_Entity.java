...
public class BossBullet_Entity {
    public JLabel label ;
    public int x_dir;
    public int y_dir;
    ...
    public BossBullet_Entity(JLabel label,int x_dir,int y_dir){
        this.label = label;
        this.x_dir = x_dir;
        this.y_dir = y_dir;
    }
    public static void attackPlayer(){
        for (int i=0;i< Main.boss_bullets_list.size();i++){
            //击中玩家
            if(Main.boss_bullets_list.get(i).label.getX()-Main.player_entity.label.getX()<=85&&
            Main.boss_bullets_list.get(i).label.getY()-Main.player_entity.label.getY()<=62&&
            Main.player_entity.label.getX()-Main.boss_bullets_list.get(i).label.getX()<=28&&
            Main.player_entity.label.getY()-Main.boss_bullets_list.get(i).label.getY()<=29){
                //开启一个线程来播放玩家死亡的动画
                new Thread(()->{
