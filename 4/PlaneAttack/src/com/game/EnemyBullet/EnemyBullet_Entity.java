...
public class EnemyBullet_Entity {
    ...
    public static void attackPlayer(){
        ...
        for(int i=0;i< Main.enemy_bullets_list.size();i++){
            if(Main.enemy_bullets_list.get(i).label.getX()-Main.player_entity.label.getX()<=85&&
                    Main.player_entity.label.getY()-Main.enemy_bullets_list.get(i).label.getY()<=29&&
                    Main.enemy_bullets_list.get(i).label.getY()-Main.player_entity.label.getY()<=62&&
                    Main.player_entity.label.getX()-Main.enemy_bullets_list.get(i).label.getX()<=18
