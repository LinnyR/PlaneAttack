...
public class Enemy implements Runnable{
    ...
    private static  ImageIcon icon3_1;
    private static  ImageIcon icon3_2;
    private static  ImageIcon icon3_3;
    private static  ImageIcon icon3_4;
    ...
    static{
        ...
        //修建敌人3_1图片
        icon3_1 = new ImageIcon("src/img/enemy3.png");
        Image temp3 = icon3_1.getImage().getScaledInstance(165, 105, icon3_1.getImage().SCALE_DEFAULT);
        icon3_1 = new ImageIcon(temp3);
        //修建敌人3_2图片
        icon3_2 = new ImageIcon("src/img/敌人3_2.png");
        Image temp3_2 = icon3_2.getImage().getScaledInstance(165, 105, icon3_2.getImage().SCALE_DEFAULT);
        icon3_2 = new ImageIcon(temp3_2);
        //修建敌人3_3图片
        icon3_3 = new ImageIcon("src/img/敌人3_3.png");
        Image temp3_3 = icon3_3.getImage().getScaledInstance(165, 105, icon3_3.getImage().SCALE_DEFAULT);
        icon3_3 = new ImageIcon(temp3_3);
        //修建敌人3_4图片
        icon3_4 = new ImageIcon("src/img/敌人3_4.png");
    ...
    public void run() {
        ...
        while (true){
            ...
            if(isTure){
                count++;
                //每循环 30 次并且敌人集合小于 6 时
                if(count%30==0&&Main.enemy_list.size()<6){
                    //生成一个随机数（1 2 3）敌人等级
                    ...
                    if(num==1){
                        ...
                        //敌人3 4种形态
                        int num3_x = random.nextInt(4)+1;//1 2 3 4

                        if(num3_x==1){
                            label_enemy.setIcon(icon3_1);
                        }else if(num3_x==2){
                            label_enemy.setIcon(icon3_2);
                        }else if(num3_x==3){
                            label_enemy.setIcon(icon3_3);
                        }else{
                            label_enemy.setIcon(icon3_4);
                        }

                        label_enemy.setBounds(x,-150, 165, 105);
                    }
